...
public class KeirseyEvaluator {
	private KeirseyLineParser.ANSWER[] dat;
	private int INDEX = 0;
	...
	private void parseChunk(KeirseyResult result) {
		...
		result.parseQuestion(KeirseyResult.GROUP.IE, dat[i++]);
		result.parseQuestion(KeirseyResult.GROUP.SN, dat[i++]);
		result.parseQuestion(KeirseyResult.GROUP.SN, dat[i++]);
		result.parseQuestion(KeirseyResult.GROUP.TF, dat[i++]);
		result.parseQuestion(KeirseyResult.GROUP.TF, dat[i++]);
		result.parseQuestion(KeirseyResult.GROUP.JP, dat[i++]);
		result.parseQuestion(KeirseyResult.GROUP.JP, dat[i++]);
	...
	/**
	 * @param data a KeirseyLineParser.ANSWER-array of kts data, typically
	 * generated by KeirseyLineParser
	 * @return a KeirseyResult representing the kts data from data
	 */
	private KeirseyResult parseDat(KeirseyLineParser.ANSWER[] data) {
