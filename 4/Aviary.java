...
public class Aviary {
	...
	public static void main(String[] args) {
		...
		int size_pixels = AviaryConstants.SIZE * AviaryConstants.PIXELS;

		//create a drawing panel
		DrawingPanel panel = new DrawingPanel(size_pixels, size_pixels);
		...
		while (true) {
			...
			g.fillRect(0, 0, size_pixels, size_pixels);
